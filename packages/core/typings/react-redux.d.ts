...
declare module 'react-redux' {
  import { Component, ComponentClass, ComponentType, Context, StatelessComponent } from 'react'
  ...
  export type ConnectedComponentClass<C extends ComponentType<any>, P> = ComponentClass<
  ...
  export interface Options<State = {}, TStateProps = {}, TOwnProps = {}, TMergedProps = {}>
  ...
  >(actions: T, deps?: ReadonlyArray<any>): ResolveArrayThunks<T>
  export function useActions<
    T extends [ActionCreator<any>, ActionCreator<any>, ActionCreator<any>, ActionCreator<any>]
  >(actions: T, deps?: ReadonlyArray<any>): ResolveArrayThunks<T>
  export function useActions<
    T extends [ActionCreator<any>, ActionCreator<any>, ActionCreator<any>]
  >(actions: T, deps?: ReadonlyArray<any>): ResolveArrayThunks<T>
  export function useActions<T extends [ActionCreator<any>, ActionCreator<any>]>(
    actions: T,
