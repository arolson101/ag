...
ChildAggregate_add(SplitTransaction, {
  required: true,
  order: 20,
  type: SecurityId,
  read: SplitTransaction.prototype.getSecurityId,
  write: SplitTransaction.prototype.setSecurityId,
})
Element_add(SplitTransaction, {
  name: 'SUBACCTSEC',
  order: 30,
  type: String,
  read: SplitTransaction.prototype.getSubAccountSecurity,
  write: SplitTransaction.prototype.setSubAccountSecurity,
})
Element_add(SplitTransaction, {
  name: 'OLDUNITS',
  order: 40,
  type: Number,
  read: SplitTransaction.prototype.getOldUnits,
  write: SplitTransaction.prototype.setOldUnits,
})
Element_add(SplitTransaction, {
  name: 'NEWUNITS',
  order: 50,
  type: Number,
  read: SplitTransaction.prototype.getNewUnits,
  write: SplitTransaction.prototype.setNewUnits,
})
Element_add(SplitTransaction, {
  name: 'NUMERATOR',
  order: 60,
  type: Number,
  read: SplitTransaction.prototype.getNumerator,
  write: SplitTransaction.prototype.setNumerator,
})
Element_add(SplitTransaction, {
  name: 'DENOMINATOR',
  order: 70,
  type: Number,
  read: SplitTransaction.prototype.getDenominator,
  write: SplitTransaction.prototype.setDenominator,
})
Element_add(SplitTransaction, {
  name: 'CURRENCY',
  order: 80,
  type: String,
  read: SplitTransaction.prototype.getCurrencyCode,
  write: SplitTransaction.prototype.setCurrencyCode,
})
Element_add(SplitTransaction, {
  name: 'ORIGCURRENCY',
  order: 90,
  type: OriginalCurrency,
  read: SplitTransaction.prototype.getOriginalCurrencyInfo,
  write: SplitTransaction.prototype.setOriginalCurrencyInfo,
})
Element_add(SplitTransaction, {
  name: 'FRACCASH',
  order: 100,
  type: Number,
  read: SplitTransaction.prototype.getCashForFractionalUnits,
  write: SplitTransaction.prototype.setCashForFractionalUnits,
})
Element_add(SplitTransaction, {
  name: 'SUBACCTFUND',
  order: 110,
  type: String,
  read: SplitTransaction.prototype.getSubAccountFund,
  write: SplitTransaction.prototype.setSubAccountFund,
})
Element_add(SplitTransaction, {
  name: 'INV401KSOURCE',
  order: 120,
  type: String,
  read: SplitTransaction.prototype.get401kSource,
  write: SplitTransaction.prototype.set401kSource,
})
