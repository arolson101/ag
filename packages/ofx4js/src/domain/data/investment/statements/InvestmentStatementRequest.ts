...
ChildAggregate_add(InvestmentStatementRequest, {
  name: 'INVACCTFROM',
  required: true,
  order: 0,
  type: InvestmentAccountDetails,
  read: InvestmentStatementRequest.prototype.getAccount,
  write: InvestmentStatementRequest.prototype.setAccount,
})
Element_add(InvestmentStatementRequest, {
  name: 'INCOO',
  order: 20,
  type: Boolean,
  read: InvestmentStatementRequest.prototype.getIncludeOpenOrders,
  write: InvestmentStatementRequest.prototype.setIncludeOpenOrders,
})
ChildAggregate_add(InvestmentStatementRequest, {
  name: 'INCPOS',
  required: true,
  ...
  read: InvestmentStatementRequest.prototype.getIncludePosition,
  write: InvestmentStatementRequest.prototype.setIncludePosition,
})
Element_add(InvestmentStatementRequest, {
  name: 'INCBAL',
  required: true,
  order: 40,
  type: Boolean,
  read: InvestmentStatementRequest.prototype.getIncludeBalance,
  write: InvestmentStatementRequest.prototype.setIncludeBalance,
})
